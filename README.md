...
```javascript
isPrime = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-prime@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-prime@v0.2.1-umd/browser.js"></script>
```
